...
-- Recreate spatial index (tipe kolom berubah, index lama sudah nggak valid)
-- Use explicit operator class for geography to avoid "no default operator class" errors
CREATE INDEX "Earthquake_geom_gist_idx" ON "Earthquake" USING GIST ("geom" gist_geography_ops);